    ...
    for ires,res in enumerate(resolutions):
        ...
        if (canvasWithRatios):
            ...
            if (ires == 0):
                ...
                g_ratio_prompt[reg][res].GetXaxis().SetRangeUser(1.0,1.1)
                g_ratio_prompt[reg][res].GetYaxis().SetRangeUser(0.0,maxEffFake)
            ...
            if (ires==0):
                ...
                g_ratio_fake[reg][res].GetXaxis().SetRangeUser(minEffPrompt,1.01)
