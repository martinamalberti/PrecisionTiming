...
h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['sig'].GetXaxis().SetRangeUser(0.0,70.0)
h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['sig'].GetYaxis().SetRangeUser(0.60,1.1)
h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['sig'].GetYaxis().SetTitle('Prompt efficiency')
h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['sig'].GetXaxis().SetTitle('Muon p_{T} (GeV)')
h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['sig'].Draw('e')
h_relChIsoEff_vs_muonpt_dZ2_dT3s_simVtx_barrel[resol[0]]['sig'].Draw('esame')
leg.AddEntry(h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['sig'],'no MTD','PL')
leg.AddEntry(h_relChIsoEff_vs_muonpt_dZ1_dT3s_simVtx_barrel[resol[0]]['sig'],'MTD, #sigma_{t} = %s ps'%resol[0],'PL')
leg.Draw('same')
tsig.Draw()
tcut.Draw()
tt['barrel'].Draw()
...
h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['bkg'].GetXaxis().SetRangeUser(0.0,70.0)
h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['bkg'].GetYaxis().SetRangeUser(0.0,0.1)
h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['bkg'].GetYaxis().SetTitle('Non-prompt efficiency')
h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['bkg'].GetXaxis().SetTitle('Muon p_{T} (GeV)')
h_relChIsoEff_vs_muonpt_dZ1_simVtx_barrel[resol[0]]['bkg'].Draw('e')
h_relChIsoEff_vs_muonpt_dZ2_dT3s_simVtx_barrel[resol[0]]['bkg'].Draw('esame')
leg.Draw('same')
tbkg.Draw()
tcut.Draw()
tt['barrel'].Draw()
...
h_relChIsoEff_vs_muonpt_dZ2_simVtx_endcap[resol[0]]['sig'].GetXaxis().SetRangeUser(0.0,70.0)
h_relChIsoEff_vs_muonpt_dZ2_simVtx_endcap[resol[0]]['sig'].GetYaxis().SetRangeUser(0.60,1.1)
h_relChIsoEff_vs_muonpt_dZ2_simVtx_endcap[resol[0]]['sig'].GetYaxis().SetTitle('Prompt efficiency')
h_relChIsoEff_vs_muonpt_dZ2_simVtx_endcap[resol[0]]['sig'].GetXaxis().SetTitle('Muon p_{T} (GeV)')
h_relChIsoEff_vs_muonpt_dZ2_simVtx_endcap[resol[0]]['sig'].Draw('e')
h_relChIsoEff_vs_muonpt_dZ3_dT3s_simVtx_endcap[resol[0]]['sig'].Draw('esame')
leg.Draw('same')
tsig.Draw()
tcut.Draw()
tt['endcap'].Draw()
...
h_relChIsoEff_vs_muonpt_dZ2_simVtx_endcap[resol[0]]['bkg'].GetXaxis().SetRangeUser(0.0,70.0)
h_relChIsoEff_vs_muonpt_dZ2_simVtx_endcap[resol[0]]['bkg'].GetYaxis().SetRangeUser(0.0,0.1)
h_relChIsoEff_vs_muonpt_dZ2_simVtx_endcap[resol[0]]['bkg'].GetYaxis().SetTitle('Non-prompt efficiency')
h_relChIsoEff_vs_muonpt_dZ2_simVtx_endcap[resol[0]]['bkg'].GetXaxis().SetTitle('Muon p_{T} (GeV)')
h_relChIsoEff_vs_muonpt_dZ2_simVtx_endcap[resol[0]]['bkg'].Draw('e')
h_relChIsoEff_vs_muonpt_dZ3_dT3s_simVtx_endcap[resol[0]]['bkg'].Draw('esame')
leg.Draw('same')
tbkg.Draw()
tcut.Draw()
tt['endcap'].Draw()
